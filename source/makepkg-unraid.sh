...
makepkg -l y -c y $TMP_DIR/iscsi.initiator-$VERSION.txz
md5sum $TMP_DIR/iscsi.initiator-$VERSION.txz | awk '{print $1}' > $TMP_DIR/iscsi.initiator-$VERSION.txz.md5
